 ...
 *
 * searchItems:
 *    function that returns the list of items to display in the search list.
 *    This function can be dynamically called during execution
 */

// Placeholder functions - will be implemented in separate modules
function getAllTabsAndCommands(): any[] {
  // TODO: Implement in Phase 2
  return [];
}

function getAllTabs(): any[] {
  // TODO: Implement in Phase 2
  return [];
}
...
function getAllSearchEngines(): any[] {
  // TODO: Implement in Phase 2
  return [];
}

export type CommandMode = "SingleExecution" | "CommandMode";
